...
try:
    ...
    # FastAPI < 0.100 doesn't have ValidationException
    from starlette.exceptions import HTTPException as ValidationException
from fastapi.responses import JSONResponse
try:
    from fastapi.utils import is_body_allowed_for_status_code
except ImportError:
    # FastAPI < 0.100 doesn't have this function
